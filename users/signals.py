...
from users.models import CustomUser  #el usuario personalizado

@receiver(post_migrate)
def create_groups(sender, **kwargs):
    if sender.name == 'users':  #ee ejecuta solo cuando se migra la app 'users'
        #definir los grupos
        ...
        #permisos específicos para cada grupo
